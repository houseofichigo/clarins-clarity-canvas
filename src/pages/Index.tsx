  ...
  return <div className="min-h-screen bg-background">
      ...
      <section id="kpi-overview" className="py-4">
        ...
        <div className="container mx-auto px-6 mt-8">
          <InsightCard type="insight" title="What This Means" content="VivaTech exhibits structural inefficiencies across all critical metrics. The 150–250x audience gap and 180–300x cost premium create an insurmountable ROI challenge that cannot be overcome through execution improvements alone." />
        </div>
      </section>
      ...
      <section id="roi-analysis" className="py-4">
        <ComparisonCharts />
        <div className="container mx-auto px-6 mt-8">
          <InsightCard type="impact" title="Why It Matters" content="ROI drives budget allocation decisions. VivaTech's 0.1–2.5x return (even in optimistic scenarios) falls significantly below the 3–5x benchmark, making it a poor investment compared to alternatives that consistently deliver superior returns." />
        </div>
      </section>
...
This section evaluates whether VivaTech 2025 meets the strategic and financial requirements for a GO decision. It applies a unified framework combining minimum GO conditions, threshold-based decision logic, and a risk matrix assessing likelihood and impact. The analysis integrates quantitative metrics and qualitative factors—ROI performance, audience relevance, brand fit, competitive positioning, and strategic alternatives—to determine if the €350–450K investment is justified.
        ...
        <div className="mt-8">
          <InsightCard type="action" title="Recommended Action" content="Proceed with NO-GO decision for VivaTech 2025. Redirect the €350–450K budget to the alternative beauty event portfolio, which delivers 3–5x ROI, 12+ months visibility, and access to 255K qualified buyers at 180–300x lower cost per attendee." />
        </div>
      ...
      <section id="competitive" className="py-4">
        <CompetitiveAnalysis />
        <div className="container mx-auto px-6 mt-8">
          <InsightCard type="insight" title="Competitive Context" content="L'Oréal and LVMH's decade-long presence with 5–10x larger investments creates an insurmountable mindshare barrier. Clarins cannot differentiate effectively with a 30–50m² booth competing against 800–3,000m² established footprints." />
        </div>
      </section>
      ...
      <footer className="border-t border-border mt-12 py-8 no-print">
        <div className="container mx-auto px-6">
          <div className="text-center space-y-4">
            ...
            <div className="mt-6">
              <a href="/references" className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors font-semibold text-sm">
